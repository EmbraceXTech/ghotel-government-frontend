...
export interface TravelLogicInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "blacklistAddresses"
      | "isBlacklisted"
...
export interface TravelLogic extends BaseContract {
  connect(runner?: ContractRunner | null): TravelLogic;
  waitForDeployment(): Promise<this>;

  interface: TravelLogicInterface;
  ...
  isTraveler: TypedContractMethod<[_address: AddressLike], [boolean], "view">;
  ...
  unWhitelistMerchants: TypedContractMethod<
    [_tokenId: BigNumberish, _addresses: AddressLike[]],
    [void],
    "nonpayable"
  >;
