...
export interface TestGhoInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BUCKET_MANAGER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface TestGho extends BaseContract {
  connect(runner?: ContractRunner | null): TestGho;
  waitForDeployment(): Promise<this>;

  interface: TestGhoInterface;
